...
interface Props { attempt: Attempt; quizTitle: string; isRepeatable: boolean; quizId: number | null }

export default function QuizResult({ attempt, quizTitle, isRepeatable, quizId }: Props) {
    ...
    return (
        <StudentLayout header={`Result — ${quizTitle}`}>
